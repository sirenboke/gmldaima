if (global.stageType == "Underworld")
{
    ...
    if (global.raiding == true)
    {
        ...
        if (!instance_exists(obj_raidPortalResults))
        {
            ...
            {
                global.portalTimer += (1 / room_speed);
    ...
    if (global.raiding == true && alarm[1] == -1)
    {
        ...
        if (room == r_underworld)
        {
            if (global.portalStage < 8)
                gml_Script_scr_textshadow((room_width / 2) + 300, room_height - 270 - 45, "Floor " + string(0 - (global.portalStage - 1)), 16777215, 0, 34, 1620);
            else
                gml_Script_scr_textshadow((room_width / 2) + 300, room_height - 270 - 45, "Underworld Core", 16777215, 0, 34, 1620);
        }
        
        if (room == r_underworld_new)
        {
            if (global.portalTower < 5)
                gml_Script_scr_textshadow((room_width / 2) + 300, room_height - 270 - 45, "Tower " + string(global.portalTower) + ", Floor " + string(global.portalFloor), 16777215, 0, 34, 1620);
            else
                gml_Script_scr_textshadow((room_width / 2) + 300, room_height - 270 - 45, "Underworld Core", 16777215, 0, 34, 1620);
        }
