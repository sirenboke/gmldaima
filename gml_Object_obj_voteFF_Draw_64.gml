if (alarm[0] == -1)
{
    if (instance_exists(votedPlayer))
    {
        ...
        draw_set_font(f_mid);
        gml_Script_scr_textshadow((room_width / 2) - 250, (room_height / 2) - 150, string(voteName) + " proposes to switch " + string(votedPlayer.name) + " with " + string(next) + ". Type !y to accept or !n to oppose.", 16777215, 0, 20, 600);
